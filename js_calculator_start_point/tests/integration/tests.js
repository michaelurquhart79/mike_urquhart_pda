...
describe('calculator functionality', function() {
  ...
  it('should update the display when multiple operations are chained together', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should update the display when result is small positive', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number3')).click();
  ...
  it('should update the display when result is small negative', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_subtract')).click();
    element(by.css('#number1')).click();
    ...
    element(by.css('#number1')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('-104')
  })

  it('should update the display when result is a decimal', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number4')).click();
  ...
  it('should update the display when result is a negative decimal', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should update the display when result is a very large number', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
    element(by.css('#number0')).click();
    element(by.css('#number0')).click();
  ...
  it('should update the display when result is a very very large number', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number1')).click();
    element(by.css('#number0')).click();
    element(by.css('#number0')).click();
    ...
    element(by.css('#number0')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('1e+27')
  })
